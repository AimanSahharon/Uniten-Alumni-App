...
class _LikedPostsScreenState extends State<LikedPostsScreen> {
  ...
  void initState() {
    super.initState();
    _fetchLikedPosts(); // Initialize liked posts on screen load
  }

  Future<void> _fetchLikedPosts() async {
    final userId = FirebaseAuth.instance.currentUser!.uid;
    _likedPostsFuture = PostService().getLikedPosts(userId);
    setState(() {}); // Refresh the UI after fetching liked posts
  }
        ...
        child: FutureBuilder<List<PostModel>>(
          ...
          builder: (context, snapshot) {
            ...
            return RefreshIndicator(
              onRefresh: _fetchLikedPosts, // Call the fetch function on refresh
